...
def checkfile():
    ...
    with open (file, 'r') as text:
        ...
        if state == "import webbrowser":
            print("The contents inside the 'Code' folder are currently not encypted.")
            ...
            response = input("Do you wish to derypt the folder to access the source code.  Y[es]/N[o]: ").lower()
            if response == 'y':
                encrypt()
            elif response == 'n':
                exit()
